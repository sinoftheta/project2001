        ...
        for (int c = 0; c < 2; c++)
        {
            for (int i = 0; i < rings; i++)
            {
                for (int j = 0; j < slices; j++) 
                {
                    ...
                    Vector3 w1 = Vector3Scale((Vector3){ 
                        capCenter.x + sinf(baseRingAngle * ( i + 0 ))*b0.x + ringSin1*b1.x + ringCos1*b2.x,
                        capCenter.y + sinf(baseRingAngle * ( i + 0 ))*b0.y + ringSin1*b1.y + ringCos1*b2.y, 
                        capCenter.z + sinf(baseRingAngle * ( i + 0 ))*b0.z + ringSin1*b1.z + ringCos1*b2.z
                    }, radius);
                    ...
                    Vector3 w2 = Vector3Scale((Vector3){ 
                        capCenter.x + sinf(baseRingAngle * ( i + 0 ))*b0.x + ringSin2*b1.x + ringCos2*b2.x, 
                        capCenter.y + sinf(baseRingAngle * ( i + 0 ))*b0.y + ringSin2*b1.y + ringCos2*b2.y, 
                        capCenter.z + sinf(baseRingAngle * ( i + 0 ))*b0.z + ringSin2*b1.z + ringCos2*b2.z 
                    }, radius);
                    ...
                    Vector3 w3 = Vector3Scale((Vector3){ 
                        capCenter.x + sinf(baseRingAngle * ( i + 1 ))*b0.x + ringSin3*b1.x + ringCos3*b2.x, 
                        capCenter.y + sinf(baseRingAngle * ( i + 1 ))*b0.y + ringSin3*b1.y + ringCos3*b2.y, 
                        capCenter.z + sinf(baseRingAngle * ( i + 1 ))*b0.z + ringSin3*b1.z + ringCos3*b2.z 
                    }, radius);
                    ...
                    Vector3 w4 = Vector3Scale((Vector3){ 
                        capCenter.x + sinf(baseRingAngle * ( i + 1 ))*b0.x + ringSin4*b1.x + ringCos4*b2.x, 
                        capCenter.y + sinf(baseRingAngle * ( i + 1 ))*b0.y + ringSin4*b1.y + ringCos4*b2.y, 
                        capCenter.z + sinf(baseRingAngle * ( i + 1 ))*b0.z + ringSin4*b1.z + ringCos4*b2.z 
                    }, radius);
